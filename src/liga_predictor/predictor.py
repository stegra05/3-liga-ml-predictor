...
from liga_predictor.modeling.data_loader import prepare_features
from liga_predictor.modeling.classifiers import ClassifierExperiment
    ...
    def update_matchday_data(self, season: str, matchday: int) -> bool:
        ...
        try:
            ...
            try:
                ...
                if not table_check.empty:
                    ...
                    if locs_check.iloc[0]['count'] == 0:
                        ...
                        from liga_predictor.processing.locations import main as build_team_locs
                        build_team_locs()
            ...
            try:
                ...
                try:
                    from liga_predictor.processing.ratings import update_latest_ratings
            ...
            try:
                from liga_predictor.processing.h2h import compute_h2h
                compute_h2h()
